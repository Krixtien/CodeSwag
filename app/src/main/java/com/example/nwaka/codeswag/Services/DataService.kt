package com.example.nwaka.codeswag.Services

import com.example.nwaka.codeswag.Model.Category
import com.example.nwaka.codeswag.Model.Product
...
object DataService {
    ...
    val hoodies = listOf(
        ...
        Product("Devslopes Gray Hoodie", "$28", "hoodie01"),
        Product("Devslopes Black Hoodie", "$28", "hoodie01")
        )
    val shirts = listOf(
